...
if __name__ == '__main__':
    ...
    element_click('//*[@id="scroll-wrapper"]/div/div/div/div/div/div/div[4]/div[1]/div[3]/div[2]')
    web_jump_next()
    time.sleep(2)
    # Join Discord
    js = (
        "var elementsWithText = Array.from(document.querySelectorAll('*')).filter(function(element) {return element.innerText && element.innerText.includes('Connect Discord');});"
